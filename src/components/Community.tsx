    ...
    <section id="community" className="py-24 bg-climb-white relative">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 auto-rows-[250px]">
          ...
          >
            <img src={images[0]} alt="Cafe" className="w-full h-full object-cover rounded-3xl transition-transform duration-700 group-hover:scale-105" />
          </motion.div>
          ...
          <motion.div 
            ...
            className="rounded-3xl overflow-hidden relative group"
          >
            <img src={images[1]} alt="Social" className="w-full h-full object-cover rounded-3xl transition-transform duration-700 group-hover:scale-105" />
          </motion.div>
          ...
          <motion.div 
            ...
            className="md:col-span-2 rounded-3xl overflow-hidden relative group h-[300px]"
          >
            <img src={images[2]} alt="Community" className="w-full h-full object-cover rounded-3xl transition-transform duration-700 group-hover:scale-105" />
          </motion.div>
        </div>
      </div>
    </section>
